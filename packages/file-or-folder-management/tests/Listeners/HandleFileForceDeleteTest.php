...
class HandleFileForceDeleteTest extends TestCase
{
    private FileStorageManager $fileStorageManager;

    private HandleFileForceDeleted $listener;
    ...
    protected function setUp(): void
    {
        ...
        $this->listener = new HandleFileForceDeleted($this->fileStorageManager);
    }
    ...
    #[Test]
    public function test_it_does_not_remove_from_storage_when_type_is_folder(): void
    {
        $fileOrFolder = Mockery::mock(FileOrFolder::class)->makePartial();
    ...
    {
        $listener = new HandleFileForceDeleted($this->fileStorageManager);

        $this->assertInstanceOf(HandleFileForceDeleted::class, $listener);
    }

    #[Test]
    public function test_it_handles_multiple_file_deletions_sequentially(): void
    {
    ...
    #[Test]
    public function test_it_only_removes_files_and_ignores_folders_in_mixed_batch(): void
    {
